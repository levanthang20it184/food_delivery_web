...
class ConfigController extends Controller
{
        public function geocode_api(Request $request)
    {
        ...
        .'&key='."AIzaSyDeFN4A3eenCTIUYvCI7dViF-N-V5X8RgA");
        ...
        public function get_zone(Request $request)
    {
        ...
        $zones = Zone::whereRaw("ST_Contains(coordinates, ST_GeomFromText('POINT($request->lat,$request->lng)'))")
                 ->latest()
                 ->first();
       /* if(count($zones)<1)
        {
    ...
    public function place_api_autocomplete(Request $request)
    {
        ...
        $response = Http::get(
            ...
            .$request['search_text']
            .'&key='
            .'AIzaSyDeFN4A3eenCTIUYvCI7dViF-N-V5X8RgA'
        );
        return $response->json();
    }
